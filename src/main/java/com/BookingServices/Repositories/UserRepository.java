...
public interface UserRepository extends JpaRepository<Accounts,Integer> {
    @Query(value = "SELECT ac.bank_id as \\\"bankId\\\", b.namebank as \\\"nameBank\\\", b.imagebank as \\\"imageBank\\\", b.typeBank as \\\"typeBank\\\", ac.accountnumber as \\\"accountNumber\\\",ac.accountName as \\\"accountName\\\" FROM accounts ac\n" +
